...
module.exports = {
    ...
    "homepage": "https://github.com/michieljoris/adea",
    ...
    "repository": {
        "type": "git",
        "url": "https://github.com/michieljoris/adea.git"
    },
    ...
    "licenses": [
        {
            "type": "MIT",
            "url": "http://github.com/michieljoris/adea/blob/master/LICENSE.txt"
        }
    ],
    ...
    //Installs a binary script called adea which is linked to
    //./bin/adea in the local package.

    //If we have installed this package globally using npm install adea
    //-g we will be able to call this new command adea from anywhere on
    //our system.
    "bin": {
	// "commit": "bin/adea.js"
    },
    ...
    "scripts": {
        ...
        "docs": "node node_modules/.bin/docco src/adea.js"
    }
};
